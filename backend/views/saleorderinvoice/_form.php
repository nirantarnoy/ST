   ...
   <label class="control-label col-sm-3" for="inputSuccess3"></label>
    <div class="col-sm-9">
        ...
        <?= Html::submitButton($model->isNewRecord ? 'Save' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
           ...
           <?= Html::button('Saleorder',['value'=>Url::to(['index.php?r=invoicerefsale/index']),'class'=>'btn btn-info','id'=>'btnshowsale'])?>
...
<div class="box">
      ...
      <tbody>
        ...
        <tr>
          <td style="text-align: center"><?php echo $product->invline; ?></td>
          <td><?php echo $product->partno; ?></td>
          <td><?php echo $product->description; ?></td>
          <td style="text-align: right"><?php echo $product->quantity; ?></td>
          <td style="text-align: right">
            <?php echo number_format($product->unitprice); ?>
          </td>
          <td style="text-align: right">
            <?php echo number_format($product->totalamount); ?>
          </td>
  ...
  return;
     ...
     $("#btnshowsale").click(function(){
      var Urls = "' . \yii::$app->getUrlManager()->createUrl('invoicerefsale/createid') . '";//$(this).attr("value");
        ...
        if(invid == null || invid =="")
        {
         alert("ต้องทำการ upload รายการ invoice ก่อน");
         return;
        }
     ...
     var xurl = "' . \yii::$app->getUrlManager()->createUrl('invoicerefsale/index') . '";
        $("#modal").modal("show")
        .find("#showmodal")
        .load(xurl);
