        ...
        <div class="col-md-4">
            <div class="box box-warning">
                <div class="box box-body">
                    ...
                    รายงานยอดขายตาม INVOICE แยกตามผู้ขาย
                </a>
                </div>
       ...
       <div class="col-md-4">
            <div class="box box-warning">
                <div class="box box-body">
                    ...
                    <i class="glyphicon glyphicon-list"></i>
                    รายงานเปรียบเทียบมูลค่าขายแยกตามผู้ขาย
                </a>
                </div>
       ...
       <div class="col-md-4">
            <div class="box box-warning">
                <div class="box box-body">
                    ...
                    <i class="glyphicon glyphicon-list"></i>
                    รายงานเปรียบเทียบยอดใบสั่งขายระหว่างปี
                </a>
                </div>
        ...
        <div class="col-md-4 form-group">
           <div class="box box-warning">
                <div class="box box-body">
                    ...
                    <i class="glyphicon glyphicon-list"></i>
                   รายงานเปรียบเทียบยอดขายตาม ACT-INVOICE
                </a>
                </div>
       ...
       <div class="col-md-4">
           <div class="box box-warning">
                <div class="box box-body">
                    ...
                    <i class="glyphicon glyphicon-list"></i>
                    รายงานเปรียบเทียบยอดขายตามกลุ่มสินค้า
                </a>
                </div>
       ...
       <div class="col-md-4">
            <div class="box box-warning">
                <div class="box box-body">
                    ...
                    <i class="glyphicon glyphicon-list"></i>
                    รายงานเปรียบเทียบยอดขายระหว่างปี
                </a>
                </div>
